...
echo "Starting Supervised Fine-tuning (SFT) on DGX Spark Grace Blackwell GB10..."
echo "Configuration:"
echo "  - Fine-tuning on curated, high-quality conversations"
echo "  - Introducing safety training"
echo "  - Optimized for single GB10 GPU with 128GB unified memory"
echo ""

# Run SFT with DGX Spark optimized settings
